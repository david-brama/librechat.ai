...
[yaml configuration](/docs/configuration/librechat_yaml) can be added using the yamlconfig entry, for example:
```
  yamlconfig: |
      version: 1.2.0
      interface:
        termsOfService:
          ...
          modalContent: "By using this service you agree to the terms of service. The content you input is your responsibility and you agree to not use this service for illegal activities."
```
